...
//		//switching to Iframe and then finding the requested webelement which is inside iframe, which is advertise area on window
...
//		Thread.sleep(3000);
		...
		System.out.println("All current browsers present on browser-after clicking alert_box from main page again = "+new2.size());	//as we again open the tab in chrome so prevoiusly opened tab==5+1, current one
